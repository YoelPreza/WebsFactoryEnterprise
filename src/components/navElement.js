...
export class NavELement extends LitElement {
    ...
    render() {
        return html`
            <nav class="text-pink-700  rounded-lg fixed top-0 w-11/12 left-1/2 -translate-x-1/2 z-50 flex justify-between items-center p-2 px-5">
                <ul class="flex items-center">
                    <img class="mx-3 border h-10 w-10 p-2 rounded-full" src="#" />
